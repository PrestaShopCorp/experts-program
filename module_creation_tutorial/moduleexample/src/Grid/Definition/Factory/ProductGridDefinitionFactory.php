...
namespace PrestaShop\ModuleExample\Grid\Definition\Factory;
...
class ProductGridDefinitionFactory extends AbstractGridDefinitionFactory
{
    ...
    {
        return $this->trans('Products', [], 'Modules.ModuleExample.Admin');
    }
    ...
    protected function getColumns()
    {
        return (new ColumnCollection())
            ...
            ->add(
                (new DataColumn('name'))
                    ->setName($this->trans('Name', [], 'Modules.ModuleExample.Admin'))
                    ->setOptions([
                        'field' => 'name',
                    ])
            )
            ->add(
                (new DataColumn('price_tax_excluded'))
                    ->setName($this->trans('Price', [], 'Modules.ModuleExample.Admin'))
                    ->setOptions([
            ...
            ->add(
                (new DataColumn('reference'))
                    ->setName($this->trans('Reference', [], 'Modules.ModuleExample.Admin'))
                    ->setOptions([
                        'field' => 'reference',
                    ])
            )
            ->add(
                (new DataColumn('active'))
                    ->setName($this->trans('Active', [], 'Modules.ModuleExample.Admin'))
                    ->setOptions([
                        'field' => 'active',
                    ])
            )
            ...
            ->add(
                (new Filter('reference', TextType::class))
                    ->setTypeOptions([
                        'required' => false,
                        'attr' => [
                            'placeholder' => $this->trans('Reference', [], 'Modules.ModuleExample.Admin'),
                        ],
                    ])
            ...
            ->add(
                (new Filter('active', TextType::class))
                    ->setTypeOptions([
                        'required' => false,
                        'attr' => [
                            'placeholder' => $this->trans('Active', [], 'Modules.ModuleExample.Admin'),
                        ],
                    ])
            ...
            ->add(
                (new Filter('actions', SearchAndResetType::class))
                    ->setTypeOptions([
                        ...
                        'redirect_route' => 'demo_grid_index_moduleexample',
                    ])
