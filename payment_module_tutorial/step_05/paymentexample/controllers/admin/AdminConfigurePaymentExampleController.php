...
class AdminConfigurePaymentExampleController extends ModuleAdminController
{
    public function __construct()
    {
        ...
        if (empty(Currency::checkPaymentCurrencies($this->module->id))) {
            $this->warnings[] = $this->trans('No currency has been set for this module.', [], 'Modules.Paymentexample.Configuration');
        }
            ...
            $this->module->name => [
                'fields' => [
                    PaymentExample::CONFIG_PO_OFFLINE_ENABLED => [
                        'type' => 'bool',
                        'title' => $this->trans('Allow to pay with offline method', [], 'Modules.Paymentexample.Configuration'),
                        'validation' => 'isBool',
                        'cast' => 'intval',
                        'required' => false,
                    ],
                    PaymentExample::CONFIG_PO_EXTERNAL_ENABLED => [
                        'type' => 'bool',
                        'title' => $this->trans('Allow to pay with external method', [], 'Modules.Paymentexample.Configuration'),
                        'validation' => 'isBool',
                        'cast' => 'intval',
                        'required' => false,
                    ],
                    PaymentExample::CONFIG_PO_EMBEDDED_ENABLED => [
                        'type' => 'bool',
                        'title' => $this->trans('Allow to pay with embedded method', [], 'Modules.Paymentexample.Configuration'),
                        'validation' => 'isBool',
                        'cast' => 'intval',
                        'required' => false,
                    ],
