...
{block name='page_title'}
  <h1 class="h1">{$moduleDisplayName} - {l s='Transactions' d='Modules.Paymentexample.Account'}</h1>
{/block}
...
{block name='page_content'}
  ...
  {else}
    <div class="alert alert-info">{l s='No transaction' d='Modules.Paymentexample.Account'}</div>
  {/if}
{/block}
