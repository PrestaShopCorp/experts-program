...
## STEP #2 - Adding Custom Order Status and Sending an Email
Based in the created offline payment, we added the module Add Custom Order Status and send an email.
